      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full bg-gray-50 border ${
            error ? 'border-rose-500/50' : 'border-gray-200/60 focus:border-indigo-500/60'
          } rounded-xl px-3 py-2.5 text-sm text-slate-800 placeholder-slate-500 outline-none transition-colors ${
            leftIcon ? 'pl-10' : ''
