      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full bg-slate-800/60 border ${
            error ? 'border-rose-500/50' : 'border-slate-700/60 focus:border-indigo-500/60'
          } rounded-xl px-3 py-2.5 text-sm text-white placeholder-slate-500 outline-none transition-colors ${
            leftIcon ? 'pl-10' : ''
