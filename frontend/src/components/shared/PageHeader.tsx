      ...
      <div className="flex items-center gap-3">
        {icon && (
          <motion.div
            ...
            className="w-12 h-12 rounded-xl bg-[var(--accent-solid)] text-[var(--accent-fg)] flex items-center justify-center shadow-sm shadow-black/10"
          >
            {icon}
          </motion.div>
        )}
        <div>
          <h1 className="text-xl md:text-3xl font-bold text-[var(--text-primary)] tracking-tight">{title}</h1>
