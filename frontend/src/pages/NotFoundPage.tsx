...
export default function NotFoundPage() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center">
      ...
      <p className="text-slate-400 mt-3 mb-1 text-lg">Sayfa bulunamadı</p>
      <p className="text-slate-500 text-sm max-w-md">
        Aradığınız sayfa kaldırılmış, ismi değişmiş veya geçici olarak erişilemez olabilir.
      </p>
      <Link
        to="/dashboard"
        className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-600 hover:to-violet-700 text-white text-sm font-medium transition-all shadow-lg shadow-indigo-500/30"
      >
        <Home size={16} />
        Dashboard'a Dön
      </Link>
